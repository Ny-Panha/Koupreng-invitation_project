...
export const KHMER_CELESTIAL_TEMPLATE = withTemplateMedia({
    ...
    family: {
        ...
        groomParents: ["លោក ឃុន ស៊ីវខេង", "លោកស្រី គុយ ដាលី"],
        groomLabel: "កូនប្រុសនាម",
        brideTitle: "ខាងកូនស្រី",
        brideParents: ["លោក ឡាំ គីមឡុង", "លោកស្រី ឡេង​ យ៉ុងស៊ី"],
        brideLabel: "កូនស្រីនាម",
    },
    messageTitle: "មានកិត្តិយសសូមគោរពអញ្ជើញ",
    dateText: "ថ្ងៃព្រហស្បតិ៍ ទី៣២ ខែធ្នូ ឆ្នាំ២០២៦",
    dateTextEn: "Wedding celebration",
    machineEventDate: "2026-12-20T17:00:00+07:00",
    targetDate: "2026-12-20T17:00:00+07:00",
    eventTime: "វេលាម៉ោង ៥:០០ ល្ងាច",
    ceremonyTime: "០៧:០០",
    receptionTime: "១៧:០០",
    ...
    description: "គំរូអាពាហ៍ពិពាហ៍ខ្មែរបែបសួនផ្កាប្រណិត ជាមួយផ្កាពណ៌ស ស្លឹកបៃតង ក្រដាសភ្លុក និងមាសសាំប៉ាញ។",
    message: "ឯកឧត្តម លោកជំទាវ លោក លោកស្រី អ្នកនាងកញ្ញា ព្រមទាំងញាតិមិត្តរាប់អានទាំងឡាយ សូមអញ្ជើញចូលរួមជាភ្ញៀវកិត្តិយស ដើម្បីប្រសិទ្ធពរជ័យជូនកូនប្រុសកូនស្រីយើងខ្ញុំ ក្នុងកម្មវិធីមង្គលអាពាហ៍ពិពាហ៍ ដែលរៀបចំឡើងដោយក្តីរីករាយ។",
    scheduleTitle: "កម្មវិធីមង្គលការ",
    scheduleDate: "ថ្ងៃព្រហស្បតិ៍ ទី៣២ ខែធ្នូ ឆ្នាំ២០២៦",
    scheduleEnding: "ចប់កម្មវិធី សូមអរគុណ!",
    thankYouTitle: "សេចក្តីថ្លែងអំណរគុណ",
    thankYouText: "យើងខ្ញុំជាមាតាបិតា កូនប្រុស - កូនស្រី សូមថ្លែងអំណរគុណយ៉ាងជ្រាលជ្រៅ ចំពោះការអញ្ជើញចូលរួម ជាភ្ញៀវកិត្តិយសក្នុងពិធីរៀបអាពាហ៍ពិពាហ៍ កូនប្រុស - កូនស្រី របស់យើងខ្ញុំ។ សូមគោរពជូនពរដល់ឯកឧត្តម លោកជំទាវ លោកអ្នកឧកញ៉ា អ្នកឧកញ៉ា លោក លោកស្រី អ្នកនាង កញ្ញា និងភ្ញៀវកិត្តិយសទាំងអស់ សូមប្រកបតែភាពសុខដុមចម្រើន និងសុភមង្គល ក្នុងក្រុមគ្រួសារជានិច្ចនិរន្តរ៍។",
    apologyTitle: "លិខិតសូមអភ័យទោស",
    ...
    dressCode: {
        ...
        style: "Botanical ceremonial elegance",
        description: "សូមជ្រើសរើសពណ៌បៃតងចាស់ បៃតងស្រាល សាំប៉ាញ ភ្លុក ឬមាសស្រាល ដើម្បីសមនឹងបរិយាកាសពិធី។",
        colors: [
            { hex: "#214F3B", name: "បៃតងចាស់" },
            { hex: "#8EA787", name: "បៃតងស្លឹក" },
            { hex: "#B88A3A", name: "មាស" },
            { hex: "#FFFAF2", name: "ភ្លុក" },
        ],
    },
    schedule: [
        { id: "krong-peali", time: "៥:០០ ព្រឹក", title: "ពិធីក្រុងពាលី" },
        { id: "guest-gathering", time: "៦:៣០ ព្រឹក", title: "ជួបជុំភ្ញៀវកិត្តិយស ដើម្បីរៀបចំហែជំនូន" },
        { id: "procession", time: "៧:០០ ព្រឹក", title: "ហែជំនូនចូលរោងជ័យ និងនិយាយជើងការ និងរៀបរាប់ផ្លែឈើ ៣៦ មុខ" },
        { id: "rings", time: "៨:០០ ព្រឹក", title: "ពិធីបំពាក់ចិញ្ចៀន" },
        { id: "blessing", time: "៩:០០ ព្រឹក", title: "ពិធីសូត្រមន្តចម្រើនព្រះបរិត្ត" },
        { id: "hair", time: "៩:៣០ - ១០:៣០ ព្រឹក", title: "ពិធីកាត់សក់បង្កក់សិរី ចម្រើនកេសា" },
        { id: "sompeas-ptem", time: "១១:០០ ព្រឹក", title: "ពិធីសំពះផ្ទឹម បង្វិលពពិល … និងចងដៃ" },
        { id: "lunch", time: "១១:៣០ ថ្ងៃត្រង់", title: "អញ្ជើញភ្ញៀវពិសាអាហារថ្ងៃត្រង់" },
        { id: "dinner", time: "៥:០០ ល្ងាច", title: "អញ្ជើញភ្ញៀវពិសាភោជនាហារពេលល្ងាច" },
    ],
    design: {
        presetId: "KHMER_CELESTIAL",
